...
class LoopForm(forms.ModelForm):
    ...
    x1 = forms.DecimalField(validators=[MinValueValidator(0)])
    y1 = forms.DecimalField(validators=[MinValueValidator(0)])
    x2 = forms.DecimalField(validators=[MinValueValidator(0)])
    y2 = forms.DecimalField(validators=[MinValueValidator(0)])
    x3 = forms.DecimalField(validators=[MinValueValidator(0)])
    y3 = forms.DecimalField(validators=[MinValueValidator(0)])
    x4 = forms.DecimalField(validators=[MinValueValidator(0)])
    y4 = forms.DecimalField(validators=[MinValueValidator(0)])
